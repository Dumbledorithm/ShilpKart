        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="grid gap-4">
            ...
            <div className="flex items-center space-x-2">
              <input type="checkbox" id="isArtisan" checked={isArtisan} onChange={(e) => setIsArtisan(e.target.checked)} className="h-4 w-4"/>
              <Label htmlFor="isArtisan" className="text-sm font-medium">Register as an Artisan</Label>
            </div>
            {isArtisan && (
              <>
                <div className="grid gap-2">
